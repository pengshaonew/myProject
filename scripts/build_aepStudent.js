...
process.env.NODE_ENV = 'production_his_wx';
  ...
  webpack(config).run((err, stats) => {
    ...
    if (publicUrl && publicUrl.indexOf('.github.io/') !== -1) {
      ...
      if (typeof appPackage.scripts.deploy === 'undefined') {
        console.log();
        if (useYarn) {
          console.log('  ' + chalk.cyan('yarn') +  ' addDispose --dev gh-pages');
        } else {
      ...
      if (publicUrl) {
        ...
        console.log('For example, addDispose this to build it for GitHub Pages:')
        console.log();
